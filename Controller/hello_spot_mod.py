...
def hello_spot(config):
    ...
    # (e.g. spot.intranet.example.com) or an IP literal (e.g. 10.0.63.1) # HERE IT IS - 192.168.80.3
    ...
    with bosdyn.client.lease.LeaseKeepAlive(lease_client, must_acquire=True, return_at_exit=True):
        ...
        print("Changing height, wait 3 seconds")
        time.sleep(3)
        cmd = RobotCommandBuilder.synchro_stand_command(body_height=0.12)
        command_client.robot_command(cmd)
        time.sleep(3)
