...
if __name__ == '__main__':
	...
	data1, _ = read_data_single.input(trainpath = r'C:\Users\j.oleksiuk_ladm\Desktop\Spot Ecosystem\prod\trainset_100425_v2.csv', isTrain= True)
	while True:
		data2, read_data_single_exit_code = read_data_single.input(trainpath = r'C:\Users\j.oleksiuk_ladm\Desktop\Spot Ecosystem\prod\19.csv', isTrain = False)
